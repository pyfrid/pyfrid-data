...
class BaseDataGroupCommand(BaseCommand):
    
    data_module=None
    
    def __init__(self, *args, **kwargs):
        super(BaseDataGroupCommand,self).__init__(*args, **kwargs)
    ...
    def validate(self,*args, **kwargs):
        res=self.data_module.validate_group(*args)
        if res: self.data_module._group_preset=True
        return res
